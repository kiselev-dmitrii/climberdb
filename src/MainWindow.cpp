...
void MainWindow::connectWidgets() {
        ...
        connect(m_ui->actSalesPlot, SIGNAL(triggered()), SLOT(processSalesPlotAction()));
}
...
void MainWindow::processSalesPlotAction() {
        SalesPlotDialog* dialog = new SalesPlotDialog(this);
        dialog->exec();
}
